  ...
  return (
    <main className="site-shell">
      <header className="nav-wrap">
        ...
        <a className="nav-cta" href="https://lensflow.com.au/creator" target="_blank" rel="noreferrer">Creator sign up <ArrowUpRight size={15} /></a>
      </header>
      ...
      <section id="top" className="hero section-pad">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="button button-primary" href="https://lensflow.com.au/creator" target="_blank" rel="noreferrer">Apply as a creator <ArrowUpRight size={17} /></a><a className="text-link" href="#how-it-works"><CirclePlay size={17} /> See how it works</a></div>
      ...
      <section className="final-cta section-pad"><div className="final-visual"><img src={roomImage} alt="LensFlow private live room" /><div className="final-overlay" /></div><div className="final-copy"><div className="eyebrow"><span className="live-dot" /> OPEN STUDIO</div><h2>There’s a room<br /><span className="editorial-accent">with your name on it.</span></h2><p>Bring your point of view. We’ll bring the private room, the tools, and a clear creator share.</p><a className="button button-primary" href="https://lensflow.com.au/creator" target="_blank" rel="noreferrer">Start your application <ArrowUpRight size={17} /></a></div></section>

      <footer className="footer"><div className="brand"><span className="brand-mark" aria-hidden="true"><i /><b /></span><span>LensFlow</span></div><p>Private live sessions. Cinematic rooms. Real voice.</p><div className="footer-right"><a href="https://lensflow.com.au/creator-dashboard" target="_blank" rel="noreferrer">Creator dashboard</a><a href="https://lensflow.com.au" target="_blank" rel="noreferrer">LensFlow.com.au</a><span><Instagram size={15} /> 18+ only</span></div></footer>
    </main>
  );
}
