    ...
    <main className="site-shell">
      ...
      <section id="top" className="hero section-pad">
        ...
        <div className="hero-visual">
          <div className="hero-image-frame" style={{ aspectRatio: "7/6" }}><img src={heroImage} alt="A LensFlow creator" style={{ objectPosition: "center 32%" }} /><div className="image-caption"><span>CREATOR PROFILE / 001</span><span>LIVE READY <i className="tiny-dot" /></span></div></div>
